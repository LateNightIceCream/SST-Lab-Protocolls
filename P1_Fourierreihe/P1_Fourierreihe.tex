...
\begin{figure}[H]
  \includegraphics[width=\textwidth]{2_1/scope_0}
...
\begin{gather*}
	\intertext{Analytische Bestimmung des Spektrums\\Aus 1.1 ergibt sich:}
...
\begin{figure}[H]
  \includegraphics[width=\textwidth]{2_2/scope_1}
  \caption{Screenshot des Rechtecksignals auf dem Oszilloskop}
\end{figure}
