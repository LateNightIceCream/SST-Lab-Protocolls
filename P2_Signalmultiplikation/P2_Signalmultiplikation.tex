...
Die einzelnen Spektrallinien des Rechtecksignals können in der Faltung beider Funktionen im Frequenzbereich als Dirac-Impulse aufgefasst werden. Da diese sich jeweils bei $n \cdot 4 \, \si{\kilo\hertz}$ wiederholen, wird die Transformation des Nachrichtensignals durch die Faltung um die Frequenz des Trägersignals periodisch verschoben.
...
untere Frequenz des ursprünglich gefalteten Signals immer näher zusammen (Abbildung X). Die beiden ursprünglichen Frequenzen rücken dabei weiter auseinander. Bei einer Frequenz von $2 \,\ \si{\kilo\hertz}$ überlappen sich die Originalfrequenz und die ursprüngliche Faltungsfrequenz und sind nicht mehr unterscheidbar.

\begin{figure}[H]
  \includegraphics[width=\textwidth]{2_1/scope_9_blue}
  \caption{Frequenzen nahe der Überschneidung}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=\textwidth]{2_1/scope_10_blue}
...
\,\ \si{\hertz}$) entstehen Schwebungen im Zeitbereich wie in Abb. x zu sehen.
...
Die periodisch auftretenden Frequenzbreiten um 7777 können z.B. als Sender bei
einer bestimmten Trägerfrequenz aufgefasst werden, welche zudem eine bestimmte
Bandbreite für die zu übertragenen Nachrichtensignale benötigen. Die in
...
Sendern notwendig ist, da sonst kein Filter realisierbar wäre, der es ermöglicht
